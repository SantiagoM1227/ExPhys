...
public :
   ...
   TH1F *cutflow_mc = new TH1F("Cutflow_mc","Cutflow; Cut; Events",10,0,10);

   TH1F *hist_lep_pt_mc = new TH1F("pT for Leptons_mc","pT for Leptons; pT; Events",140,0,140);

   TH1F *hist_lep_eta_mc = new TH1F("eta for Leptons_mc","eta for Leptons; eta; Events",60,-3,3);
   
   TH1F *hist_njets_before_mc  = new TH1F("Number of Jets before cut_mc","n-jets; Jet multiplicity; Events",10,0,10);
   TH1F *hist_njets_after_mc = new TH1F("Number of Jets_mc","n-jets; Jet multiplicity; Events",10,0,10);
   
   TH1F *hist_jet_pt_mc = new TH1F("pT for Jets_mc","pT for Jets; pT; Events",200,0,200);

   TH1F *hist_jet_eta_mc = new TH1F("eta for Jets_mc","eta for Jets; eta; Events",60,-3,3);
   
   TH1F *hist_jet_jvf_mc = new TH1F("JVF score for Jets_mc","JVF score for Jets; JVF score; Events",100,0,1);
   
   TH1F *hist_jet_mv1_mc = new TH1F("Mv1 score for Jets_mc","Mv1 score for Jets; Mv1 score; Events",100,0,1);
   
   TH1F *hist_nbjet_mc = new TH1F("Number of b-Jets_mc","Number of b-Jets; Number of b-Jets; Events",10,0,10);

   TH1F *hist_met_mc = new TH1F("MET score for Jets_mc","MET score for Jets; MET score; Events",150,0,150);
   
   TH1F *hist_mtW_mc = new TH1F("mTW_mc","mT W; mT W; Events",150,0,150);
