...
class TopAnalysis : public TSelector {
  ...
  TH1F *hist_vismass      = 0;
  TH1F *hist_mt      = 0;
  TH1F *hist_deltaphi = 0;
  TH1F *hist_ptleptons = 0;
  ...
  // Leading Lepton histograms
  TH1F *hist_trailleptpt   = 0;
  TH1F *hist_traillepteta  = 0;
  TH1F *hist_trailleptE    = 0;
  TH1F *hist_trailleptphi  = 0;
  TH1F *hist_trailleptch   = 0;
  TH1F *hist_trailleptID   = 0;
  TH1F *hist_traillept_ptc  = 0;
  TH1F *hist_trailleptetc  = 0;
  TH1F *hist_traillepz0    = 0;
  TH1F *hist_traillepd0    = 0;
  ...
  virtual void    FillHistogramsTraillept( double m, float w , TString s);
