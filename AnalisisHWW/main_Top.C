...
void main_Top(int proof)
{
  ...
  /* Local path example */
  TString path = "/home/japr/Documentos/Semestre10/Particulas/HEP-Exp-Course/RootFiles/";
...
*/
  ...
  chain_data->AddFile("/home/japr/Documentos/Semestre10/Particulas/HEP-Exp-Course/RootFiles/Data_8TeV.root");
