		...
		if(goodjet_n >= 4)
		  {
			...
			if(met_et > 30000.)
			  ...
			  TLorentzVector Jet1_Jet2 = TLorentzVector();
			  TLorentzVector Jet1_Jet2_Jet3 = TLorentzVector();
			  ...
			  Jet3.SetPtEtaPhiE(jet_pt[goodjet_index[2]],jet_eta[goodjet_index[2]],jet_phi[goodjet_index[2]],jet_E[goodjet_index[2]]);
			  
			  Jet1_Jet2 = Jet1 + Jet2;
			  Jet1_Jet2_Jet3 = Jet1 + Jet2 + Jet3;

			  float InvMass2 = Jet1_Jet2.Mag();
			  float InvMass2_inGeV = InvMass2/1000.;

			  float InvMass3Jets = Jet1_Jet2_Jet3.Mag();
			  float InvMass3Jets_inGeV = InvMass3Jets/1000.;


			  TLorentzVector bJet1 = TLorentzVector();
			  //TLorentzVector bJet2 = TLorentzVector();

			  bJet1.SetPtEtaPhiE(jet_pt[goodbjet_index[0]],jet_eta[goodbjet_index[0]],jet_phi[goodbjet_index[0]],jet_E[goodbjet_index[0]]);
			  //bJet2.SetPtEtaPhiE(jet_pt[goodbjet_index[1]],jet_eta[goodbjet_index[1]],jet_phi[goodbjet_index[1]],jet_E[goodbjet_index[1]]);

			  TLorentzVector ComponentsZ = TLorentzVector();
			  //ComponentsZ = Lepton_1 + MeT + Jet1 + Jet2 + bJet1 + bJet2;
			  ComponentsZ = Lepton_1 + MeT + Jet1 + Jet2 + Jet3 + bJet1;
			  float InvMassZ = ComponentsZ.Mag();
			  float InvMassZ_inGeV = InvMassZ/1000.; 

				double names_of_global_variable[]={InvMass1_inGeV, missingEt, vxp_z, (double)pvxp_n, Lepton1_MeT_MT/1000., InvMass2_inGeV, InvMass3Jets_inGeV, InvMassZ_inGeV};
				...
				TString histonames_of_global_variable[]={"hist_vismass","hist_etmiss","hist_vxp_z","hist_pvxp_n", "hist_mt", "hist_invmass2", "hist_invmass3", "hist_invmassZ"};
